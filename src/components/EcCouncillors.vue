    ...
    <ul class="ec-councillors">
        ...
        >
            ...
            <div class="ec-councillor-details">
                <h3 class="ec-councillor-name">{{ councillor.name }}</h3>
                <div class="ec-councillor-party">{{ councillor.party }}</div>
...
.ec-councillor {
    ...
    box-shadow: 0 2px 5px #B50A0022;
    outline: 1px solid #B50A001C;
    overflow: hidden;
